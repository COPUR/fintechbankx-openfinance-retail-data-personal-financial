...
- **Squad:** Retail Data Squad
- **Repo Kümesi:** `openfinance-data`
- **Bounded Context:** `open-finance`
- **Ana Capability:** Personal financial data retrieval (AIS Retail)
- **Dönüşüm Wave:** 2
...
- `Personal financial data retrieval (AIS Retail)` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
