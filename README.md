...
Bu repository, FinTechBankX DDD/EDA dönüşümünde **svc-of-personal-financial-data** servis yetkinliğinin kaynak kodunu, kontratlarını ve operasyonel guardrail'lerini içerir.
...
## Kapsam
### In Scope
- personal_financial_data bağlamına ait uygulama kodu, testler ve otomasyon.
